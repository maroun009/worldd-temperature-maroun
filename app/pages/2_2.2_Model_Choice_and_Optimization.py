...
greenhouse_gas = Image.open("app/img/Graph1.jpg")
st.image(greenhouse_gas)
st.markdown("")

greenhouse_gas = Image.open("app/img/Graph2.jpg")
st.image(greenhouse_gas)
st.markdown("")

greenhouse_gas = Image.open("app/img/Graph3.jpg")
st.image(greenhouse_gas)
st.markdown("")
...
greenhouse_gas = Image.open("app/img/Graph6.jpg")
st.image(greenhouse_gas)
st.markdown("")
